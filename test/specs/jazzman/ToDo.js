topSuite("Ext.jazzman.ToDo", [false], function() {
    ...
    it("SOME TESTS SHOULD FAIL HERE (INCLUDING THIS ONE). THIS IS EXPECTED.", function() {
    ...
    toDo("qux").
    describe("immediate resolution: all specs pass but suite reported as failed", function() {
