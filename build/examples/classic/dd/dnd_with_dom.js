Ext.onReady(function() {
    ...
    var overrides = {
        ...
        carElements = Ext.get('cars').select('div'),
        truckElements, rentedDDTarget, repairDDTarget;
    ...
    truckElements = Ext.get('trucks').select('div');
    ...
    Ext.create('Ext.dd.DDTarget', 'cars', 'carsDDGroup');
    Ext.create('Ext.dd.DDTarget', 'trucks', 'trucksDDGroup');

    // Instantiate instnaces of DDTarget for the rented and repair drop target elements
    rentedDDTarget = Ext.create('Ext.dd.DDTarget', 'rented', 'carsDDGroup');
    repairDDTarget = Ext.create('Ext.dd.DDTarget', 'repair', 'carsDDGroup');
